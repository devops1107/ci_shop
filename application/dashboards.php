            ...
            <div class="page-content container-fluid">
                        ...
                        <div class="p-lg-3 p-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ml-4" style="width: 38%;">
                                    <h4 class="font-light">Total Categories</h4>
                                    <div class="progress">
                                        <div class="progress-bar bg-cyan" role="progressbar" style="width: <?=$totalCategories?>%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="40"></div>
                                    </div>
                                </div>
                                <div class="ml-auto">
                                    <h2 class="display-7 mb-0"><?=$totalCategories?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card p-2 p-lg-3">
                        <div class="p-lg-3 p-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ml-4" style="width: 39%;">
                                    <h4 class="font-light">Total Active Live Sweepstakes</h4>
                                    <div class="progress">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: <?=$totalActiveLiveSweepstakes?>%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="40"></div>
                                    </div>
                                </div>
                                <div class="ml-auto">
                                    <h2 class="display-7 mb-0"><?=$totalActiveLiveSweepstakes?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card p-2 p-lg-3">
                        <div class="p-lg-3 p-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ml-4" style="width: 39%;">
                                    <h4 class="font-light">Total Inactive Live Sweepstakes</h4>
                                    <div class="progress">
                                        <div class="progress-bar bg-danger" role="progressbar" style="width: <?=$totalInactiveLiveSweepstakes?>%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="40"></div>
                                    </div>
                                </div>
                                <div class="ml-auto">
                                    <h2 class="display-7 mb-0"><?=$totalInactiveLiveSweepstakes?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                     <div class="card p-2 p-lg-3">
                        <div class="p-lg-3 p-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ml-4" style="width: 39%;">
                                    <h4 class="font-light">Total Active Queued Sweepstakes</h4>
                                    <div class="progress">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: <?=$totalActiveQueuedSweepstakes?>%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="40"></div>
                                    </div>
                                </div>
                                <div class="ml-auto">
                                    <h2 class="display-7 mb-0"><?=$totalActiveQueuedSweepstakes?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card p-2 p-lg-3">
                        <div class="p-lg-3 p-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ml-4" style="width: 39%;">
                                    <h4 class="font-light">Total Inactive Queued Sweepstakes</h4>
                                    <div class="progress">
                                        <div class="progress-bar bg-danger" role="progressbar" style="width: <?=$totalInactiveQueuedSweepstakes?>%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="40"></div>
                                    </div>
                                </div>
                                <div class="ml-auto">
                                    <h2 class="display-7 mb-0"><?=$totalInactiveQueuedSweepstakes?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="card p-2 p-lg-3">
                        <div class="p-lg-3 p-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ml-4" style="width: 39%;">
                                    <h4 class="font-light">Total Active Expired Sweepstakes</h4>
                                    <div class="progress">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: <?=$totalActiveExpiredSweepstakes?>%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="40"></div>
                                    </div>
                                </div>
                                <div class="ml-auto">
                                    <h2 class="display-7 mb-0"><?=$totalActiveExpiredSweepstakes?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card p-2 p-lg-3">
                        <div class="p-lg-3 p-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ml-4" style="width: 39%;">
                                    <h4 class="font-light">Total Inactive Expired Sweepstakes</h4>
                                    <div class="progress">
                                        <div class="progress-bar bg-danger" role="progressbar" style="width: <?=$totalInactiveExpiredSweepstakes?>%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="40"></div>
                                    </div>
                                </div>
                                <div class="ml-auto">
                                    <h2 class="display-7 mb-0"><?=$totalInactiveExpiredSweepstakes?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card p-2 p-lg-3">
                        <div class="p-lg-3 p-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ml-4" style="width: 39%;">
                                    <h4 class="font-light">Total Sweepstakes</h4>
                                    <div class="progress">
                                        <div class="progress-bar bg-danger" role="progressbar" style="width: <?=$totalSweepstakes?>%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="40"></div>
                                    </div>
                                </div>
                                <div class="ml-auto">
                                    <h2 class="display-7 mb-0"><?=$totalSweepstakes?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="card p-2 p-lg-3">
                        <div class="p-lg-3 p-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ml-4" style="width: 39%;">
                                    <h4 class="font-light">Total Purchased Tickets</h4>
                                    <div class="progress">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: <?=$totalPurchasedTickets?>%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="40"></div>
                                    </div>
                                </div>
                                <div class="ml-auto">
                                    <h2 class="display-7 mb-0"><?=$totalPurchasedTickets?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card p-2 p-lg-3">
                        <div class="p-lg-3 p-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ml-4" style="width: 39%;">
                                    <h4 class="font-light">Total Direct Purchased Tickets</h4>
                                    <div class="progress">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: <?=$totalDirectPurchasedTickets?>%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="40"></div>
                                    </div>
                                </div>
                                <div class="ml-auto">
                                    <h2 class="display-7 mb-0"><?=$totalDirectPurchasedTickets?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title text-uppercase">New Registered Users</h5>
                                ...
                                <div id="ct-users" style="height: 320px;"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-12">
                                            ...
                                            <table class="table no-wrap">
                                                ...
                                                <tbody>
                                                    <tr class="advanced-table active">
                                                        ...
                                                        <td>
                                                            <img src="<?=ADMIN_PATH?>images/users/1.jpg" class="rounded-circle" width="30">
                                                        </td>
                                                        <td>Andrew Simons</td>
                                                        <td>Modulator</td>
                                                        <td>6 May 2016</td>
                                                    ...
                                                    <tr class="advanced-table">
                                                        ...
                                                        <td>
                                                            <img src="<?=ADMIN_PATH?>images/users/2.jpg" class="rounded-circle" width="30">
                                                        </td>
                                                        <td>Hanna Gover</td>
                                                        <td>Admin </td>
                                                        <td>13 Jan 2005</td>
                                                    ...
                                                    <tr class="advanced-table">
                                                        ...
                                                        <td>
                                                            <img src="<?=ADMIN_PATH?>images/users/3.jpg" class="rounded-circle" width="30">
                                                        </td>
                                                        <td>Joshi Nirav</td>
                                                        <td>Admin</td>
                                                        <td>21 Mar 2001</td>
                                                    ...
                                                    <tr class="advanced-table">
                                                        ...
                                                        <td>
                                                            <img src="<?=ADMIN_PATH?>images/users/4.jpg" class="rounded-circle" width="30">
                                                        </td>
                                                        <td>Joshi Sunil</td>
                                                        <td>Admin</td>
                                                        <td>21 Mar 2004</td>
                                    ...
                                    <ul class="list-task todo-list list-group mb-0" data-role="tasklist">
                                        <li class="list-group-item todo-item pt-0" data-role="task">
                                            ...
                                            <ul class="list-style-none assignedto mt-2">
                                                <li class="assignee"><img class="assignee-img" src="<?=ADMIN_PATH?>images/users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                                <li class="assignee"><img class="assignee-img" src="<?=ADMIN_PATH?>images/users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                                <li class="assignee"><img class="assignee-img" src="<?=ADMIN_PATH?>images/users/3.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                                <li class="assignee"><img class="assignee-img" src="<?=ADMIN_PATH?>images/users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                            </ul>
                                        </li>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="card">
                            <img class="card-img-top" src="<?=ADMIN_PATH?>images/big/img1.jpg" alt="Card image cap">
                            <div class="card-body">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card">
                            <img class="card-img-top" src="<?=ADMIN_PATH?>images/big/img2.jpg" alt="Card image cap">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center mb-3">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card">
                            <img class="card-img-top" src="<?=ADMIN_PATH?>images/big/img3.jpg" alt="Card image cap">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center mb-3">
                                ...
                                <ul class="list-style-none chat-list">
                                    <li class="mb-3">
                                        <a href="javascript:void(0)">
                                            <div class="d-flex align-items-center">
                                                <img src="<?=ADMIN_PATH?>images/users/1.jpg" class="rounded-circle" width="40">
                                                <div class="ml-3">
                                    ...
                                    <li class="mb-3">
                                        <a href="javascript:void(0)">
                                            <div class="d-flex align-items-center">
                                                <img src="<?=ADMIN_PATH?>images/users/2.jpg" class="rounded-circle" width="40">
                                                <div class="ml-3">
                                    ...
                                    <li class="mb-3">
                                        <a href="javascript:void(0)">
                                            <div class="d-flex align-items-center">
                                                <img src="<?=ADMIN_PATH?>images/users/3.jpg" class="rounded-circle" width="40">
                                                <div class="ml-3">
                                    ...
                                    <li class="mb-3">
                                        <a href="javascript:void(0)">
                                            <div class="d-flex align-items-center">
                                                <img src="<?=ADMIN_PATH?>images/users/4.jpg" class="rounded-circle" width="40">
                                                <div class="ml-3">
                                    ...
                                    <li class="mb-3">
                                        <a href="javascript:void(0)">
                                            <div class="d-flex align-items-center">
                                                <img src="<?=ADMIN_PATH?>images/users/5.jpg" class="rounded-circle" width="40">
                                                <div class="ml-3">
                                    ...
                                    <li class="mb-3">
                                        <a href="javascript:void(0)">
                                            <div class="d-flex align-items-center">
                                                <img src="<?=ADMIN_PATH?>images/users/6.jpg" class="rounded-circle" width="40">
                                                <div class="ml-3">
                                                    <h5 class="mb-0 text-dark">Varun Dhavan</h5>
                                                    <small class="text-success">Online</small>
                                                </div>
                                ...
                                <div class="steamline mt-0">
                                  ...
                                  <i class="fas fa-image"></i> 
                                        ...
                                        <div class="sl-right">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col">
                                                    <img src="<?=ADMIN_PATH?>images/big/img1.jpg" class="img-fluid">
                                                </div>
                                                <div class="col">
                                                    <img src="<?=ADMIN_PATH?>images/big/img2.jpg" class="img-fluid">
                                                </div>
                                                <div class="col">
                                                    <img src="<?=ADMIN_PATH?>images/big/img3.jpg" class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="<?=ADMIN_PATH?>images/users/1.jpg" alt="user" class="rounded-circle" /> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="<?=ADMIN_PATH?>images/users/2.jpg" alt="user" class="rounded-circle" /> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="<?=ADMIN_PATH?>images/users/5.jpg" alt="user" class="rounded-circle" /> </div>
                                        <div class="sl-right">
                            ...
                            <div class="card-body">
                                <div class="chat-box scrollable" style="height:434px;">
                                    ...
                                    <ul class="chat-list">
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="<?=ADMIN_PATH?>images/users/1.jpg" alt="user"></div>
                                        ...
                                        <li class="odd chat-item">
                                            ...
                                            <div class="chat-img"><img src="<?=ADMIN_PATH?>images/users/2.jpg" alt="user"></div>
                                        </li>
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="<?=ADMIN_PATH?>images/users/3.jpg" alt="user"></div>
                                            <div class="chat-content">
                                                <div class="box bg-light-success">
...
<?php 
$temp_arr= array();
	foreach($new_monthly_registered_users_arr as $key=>$value){ 
		$temp_arr[$value['m']] = $value['users'];
		
	}	 
//$visitArr = array(5,2,7,4,5,3,5,4,4,6,3,7);
$visitArr = array();
$months = array();
for($i=date('m')+1;$i!=date('m');$i++){ 
    ...
    ?>
        user_series.push(0);
	<?php }else{ 
		$visitArr[$i] = $temp_arr[$i];?>
		user_series.push(<?=$temp_arr[$i]?>);
	<?php } ?>
<?php }
?>
//alert(user_series);
...
<script src="<?=ADMIN_PATH?>libs/chartist/dist/chartist.min.js"></script>
<script src="<?=ADMIN_PATH?>js/pages/chartist/chartist-plugin-tooltip.js"></script>
<script src="<?=ADMIN_PATH?>js/pages/dashboards/dashboard1.js"></script>