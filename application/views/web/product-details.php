                                    ...
                                    <div class="product-info">
                                        ...
                                        <div>
                                            <div class="button-group-pills text-left" data-toggle="buttons">
                                                ...
                                                if($pdetails['single_product_price'] > 0)
                                                {
                                                   ...
                                                   ?>
                                                    <label class="btn btn-default active">
                                                        <input class="productPriceType" type="radio" value="<?php echo base64_encode(1); ?>" name="productPriceType" checked="checked">
                                                        <div>Stück (Stk.) </div>
                                                    </label>
                                                    <?php
                                                }
                                                ...
                                                {
                                                    ?>
                                                    <label class="btn btn-default <?php echo ($checkedPrdType == 0) ? 'active' : '';?>">
                                                        <input class="productPriceType" type="radio" value="<?php echo base64_encode(2); ?>" name="productPriceType" <?php echo ($checkedPrdType == 0) ? 'checked' : '';?>>
                                                        <div>Umkarton (Kolli) </div>
                                                    </label>
                                                    <?php
                                                    $checkedPrdType = 1;
                                                }
                                                ...
                                                {   ?> 
                                                    <label class="btn btn-default <?php echo ($checkedPrdType == 0) ? 'active' : '';?>">
                                                        <input class="productPriceType" type="radio" value="<?php echo base64_encode(3); ?>" name="productPriceType" <?php echo ($checkedPrdType == 0) ? 'checked' : '';?> >
                                                        <div>Display </div>
                                                    </label>
                                                    <?php
                                                }   ?> 
                                        ...
                                        <div>
                                            ...
                                            <!-- <div class="input-group pull-left">
                                                ...
                                                if($pdetails['single_product_price'] > 0)
                                                {   ?>
                                                    <option value="<?php echo base64_encode(1); ?>">Stück (Stk.)</option>
                                                    <?php
                                                }
                                                if($pdetails['master_carton_price'] > 0)
                                                {   ?>    
                                                    <option value="<?php echo base64_encode(2); ?>">Umkarton (Kolli)</option>>
                                                    <?php
                                                }
                                                if($pdetails['palette_price'] > 0)
                                                {   ?> 
                                                    <option value="<?php echo base64_encode(3); ?>">Palette</option>>
                                                    <?php
                                                }   ?> 
                                                </select>
                                            </div> -->

                                            <div class="input-group qty-btn pull-left ml-0">
                                                ...
                                                <input id="prodQuantity" type="text" name="quant" class="form-control input-number ml-0" value="1" >
                                                <span class="input-group-btn"> 
                                            ...
                                            <a id="addProdCart" href="javascript:void(0);" class="btn btn-info btn-large"><?=$this->lang->line('add_to_cart')?></a>
                                        </div>
                                    </div>
...
$(document).ready(function(){    
    $(".btn-number").on("click", function() {
      ...
      var productPriceType = $("input[name='productPriceType']:checked").val(); //$('#productPriceType').val();
      ...
      if(atob(productPriceType) == 1)
        var prodTitle = 'Stück (Stk.)';
      else if(atob(productPriceType) == 2)
        var prodTitle = 'Umkarton (Kolli)';
      else if(atob(productPriceType) == 3)
        var prodTitle = 'Palette';
    ...
    $('input[type=radio][name=productPriceType]').change(function() {    
