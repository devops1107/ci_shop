                        ...
                        <div class="panel-body">
                          <div class="pro-table">
                            ...
                            <div class="cart-table">
                              <?php 
                                $product_tax = $total_order_net_amount*($tax_percent/100);
                                $total_full_order_amount = $total_order_net_amount+$product_tax;
                                ?>
                              <table class="table">
                              <tbody>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td>€ <?php echo sprintf("%0.2f",$product_tax); ?></td>
                                </tr>
                                <tr class="total">
                                  <td class="title"><?=$this->lang->line('grand_total')?></td>
                                  <td>€ <?php echo sprintf("%0.2f",$total_full_order_amount); ?></td>
                                </tr>
                              </tbody>
                              </table>
                            </div>
            	...
            	<div class="checkout-progress">
                    ...
                    <div class="detail-wrapper">
                      <div class="title"><?=$this->lang->line('order_amount')?></div>
                        <div class="info">
                          <p><?=$this->lang->line('subtotal')?> - <strong class="text-right pull-right">€ <?php echo sprintf("%0.2f",$total_order_amount); ?></strong></p>
                          <p><?=$this->lang->line('discount')?> - <strong class="text-right pull-right">€ <?php echo sprintf("%0.2f",$total_order_discount); ?></strong></p>
                          <?php
                            $product_tax = sprintf("%0.2f",($total_order_net_amount*($tax_percent/100)));
                            $total_order_full_amount = sprintf("%0.2f",($total_order_net_amount+$product_tax));
                            ?>
                          <p><?=$this->lang->line('tax')?> (<?php echo $tax_percent; ?>%) - <strong class="text-right pull-right">€ <?php echo $product_tax; ?></strong></p>
                          <p><?=$this->lang->line('grand_total')?> - <strong class="text-right pull-right">€ <?php echo $total_order_full_amount; ?></strong></p>
                        </div>
                    </div>
                </div>
            </div>
