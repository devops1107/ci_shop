...
<div class="page-breadcrumb bg-white">
	<div class="row">
		<div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
			<?php if($uri3 == "TOKEN"){ ?>
				<h5 class="font-medium text-uppercase mb-0">Purchased tickets</h5>
			<?php }else{ ?>
				<h5 class="font-medium text-uppercase mb-0">Direct Purchased</h5>
			<?php } ?>
		</div>
		<div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
			<nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
				<ol class="breadcrumb mb-0 justify-content-end p-0 bg-white">
					...
					<?php if($uri3 == "TOKEN"){ ?>
						<li class="breadcrumb-item active" aria-current="page">Purchased tickets</li>
					<?php }else{ ?>
						<li class="breadcrumb-item active" aria-current="page">Direct Purchased</li>
					<?php } ?>
				</ol>
			</nav>
		</div>
...
$(document).ready(function() {
	$('#tbl_all').dataTable({
		...
		"sAjaxSource": '<?php echo base_url('admin/user-purchase-ticket/'.$this->uri->segment(3)."/".$this->uri->segment(4))?>',
		"bProcessing": true,
		"bLengthChange":true,
		"bServerSide": true,
		"bAutoWidth": false,
			'aoColumns': [ {"bSortable":false},{"bSortable":false},{"bSortable":false},{"bSortable":false},{"bSortable":false, "class":"hide_on_print" },],
