...
<div class="page-breadcrumb bg-white">
	<div class="row">
		<div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
			<h5 class="font-medium text-uppercase mb-0">Winnings</h5>
		</div>
		<div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
			<nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
				<ol class="breadcrumb mb-0 justify-content-end p-0 bg-white">
					...
					<li class="breadcrumb-item active" aria-current="page">Winnings</li>
				</ol>
			</nav>
		</div>
	</div>
...
$(document).ready(function() {
	$('#tbl_all').dataTable({
		...
		"sAjaxSource": '<?php echo base_url('admin/user-winnings/'.$this->uri->segment(3))?>',
		"bProcessing": true,
		"bLengthChange":true,
		"bServerSide": true,
		"bAutoWidth": false,
