...
<div class="page-breadcrumb bg-white">
	<div class="row">
		<div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
			<h5 class="font-medium text-uppercase mb-0">Slider</h5>
		</div>
            ...
            <div class="material-card card">
				<section class="card min_height">
	            	<?php $this->load->view('admin/layout/validation-errors'); ?>
	              	<div class="card-body">
						<a href="<?php echo base_url('admin/add-slider')?>" class="btn btn-success pull-right btn-sm  table_add">Add Slider</a>
			            <div class="adv-table">
						<table  class="display table table-bordered table-striped" id="tbl_all">
				              	<thead>
					              	<tr>
										...
										<th class="hide_on_print" width="15%;">Action</th>
					              	</tr>
				             	</thead>
			              	</table>
			            </div>
...
<script>
	$("table").on('click','.btn_del',function(){
        ...
        return confirm('Are you sure for '+status+' this slider?');
   });
</script>
...
<script>
	function confirm_delete(){
		return confirm("Do you really want to delete this slider?");
	}
</script>
...
$(document).ready(function() {
	$('#tbl_all').dataTable({
		...
		"sAjaxSource": '<?php echo base_url()?>admin/slider',
		"bProcessing": true,
		"bLengthChange":true,
		"bServerSide": true,
		"bAutoWidth": false,
