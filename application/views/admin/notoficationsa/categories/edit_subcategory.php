										...
										<div class="row">
											...
											<div class="form-group col-md-4 has-feedback">
												...
												<?php
													...
													echo form_dropdown($data, $allcategory,$subcategory_details['category_id']);
												?>
											</div>
											<div class="form-group col-md-4 has-feedback">
												...
												<?php
													...
													'class'			=>"form-control",
													'value'	=> (!empty($subcategory_details) && $subcategory_details['subcategory_name'])?$subcategory_details['subcategory_name']:''
													);
											...
											<div class="form-group col-md-4 has-feedback">
												...
												<?php
													...
													'class'			=>"form-control",
													'value'	=> (!empty($subcategory_details) && $subcategory_details['subcategory_name_gr'])?$subcategory_details['subcategory_name_gr']:''
													);
													echo form_input($data);
												?> 
											</div>
											<div class="form-group col-md-4 has-feedback">
												...
												<?php
													...
													'class'			=>"form-control",
													'value'	=> (!empty($subcategory_details) && $subcategory_details['subcategory_name_tr'])?$subcategory_details['subcategory_name_tr']:''
													);
													echo form_input($data);
												?> 
											</div>
											<div class="form-group col-md-6 has-feedback">
												<div class="row">
													...
													<input type="file" accept="image/x-png,image/jpeg" name="subcategory_image" class="form-control-file">
												</div>
													
													<div class="form-group col-md-1 has-feedback mt-2">
														<?php 
															 //$image_url=(!empty($subcategory_details) && $subcategory_details['category_image'])?$subcategory_details['category_image']:''?>
														<?php if($subcategory_details['subcategory_image']!="" && file_exists(UPLOAD_PHYSICAL_PATH.'/categories/'.$subcategory_details['subcategory_image'])){ ?>
															<img src="<?=UPLOAD_URL.'categories/'.$subcategory_details['subcategory_image']?>" width="50px" height="50px"/>	
													   <?php } else { ?>
