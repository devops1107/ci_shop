<div class="page-breadcrumb bg-white">
	<div class="row">
		<div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
			<h5 class="font-medium text-uppercase mb-0">Add New Category</h5>
		</div>
									...
									<div class="card_box">
										...
										<div class="row">
											...
											<div class="form-group col-md-12 has-feedback">
												...
												<input type="file" required="" accept="image/jpeg,image/x-png" name="category_image" class="form-control-file"> 
											</div>
