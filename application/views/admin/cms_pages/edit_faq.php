					...
					<div class="row">
						...
						<div class="col-md-7 col-xs-12 col-sm-12 height_360 ">
							  <?php echo validation_errors(); ?>
                                  <?php $id=base64_encode($detail['faq_id']); ?>
							...
							<div class="form-group has-feedback">
								<label>Quetion (GR): </label>
								<?php
									$data = array(
									'name'			=> 'question_gr',
									'id'			=> 'question_gr',
									//'required'		=> "required",
									'placeholder'	=> "Quetion (GR)",
									'value'         => $detail['question_gr'],
									'class'			=>"form-control",
									);
									echo form_input($data);
								?>
							...
							<div class="form-group has-feedback">
								<label>Quetion (TR): </label>
								<?php
									$data = array(
									'name'			=> 'question_tr',
									'id'			=> 'question_tr',
									//'required'		=> "required",
									'placeholder'	=> "Quetion (TR)",
									'value'         => $detail['question_tr'],
									'class'			=>"form-control",
									);
									echo form_input($data);
								?>
