...
<div class="page-breadcrumb bg-white">
	<div class="row">
		<div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
			<h5 class="font-medium text-uppercase mb-0">Brands</h5>
		</div>
            ...
            <div class="material-card card">
				<section class="card min_height">
	            	<?php $this->load->view('admin/layout/validation-errors'); ?>
	              	<div class="card-body">
						<a href="<?php echo base_url('admin/add-brand')?>" class="btn btn-success pull-right btn-sm  table_add">Add Brand</a>
			            <div class="adv-table">
				              	...
				              	<thead>
					              	<tr>
					                 	<th>Sr No.</th>
					                  	...
					                  	<th>Brand Name German</th>
					                  	<th>Brand Name Turkish</th>
					                  	<th>Status</th>
...
<script>
	$("table").on('click','.btn_dec',function(){
        ...
        return confirm('Are you sure for '+status+' this Brand?');
    });

	$("table").on('click','.btn_del',function(){
        return confirm("Do you really want to delete this Brand?");
   });
</script>
...
$(document).ready(function() {
	$('#tbl_all').dataTable({
		...
		"sAjaxSource": '<?php echo base_url('admin/brands')?>',
		"bProcessing": true,
		"bLengthChange":true,
		"bServerSide": true,
		"bAutoWidth": false,
